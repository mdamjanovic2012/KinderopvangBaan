...
WP_SCRAPERS = [
    ...
    (SolidoeScraper,        "solidoe",           "/vacatures/"),
    (UniKidzScraper,        "unikidz",           "/vacatures/"),
    (VlietkinderenScraper,  "vlietkinderen",     "/vacatures/"),
    (WelluswijsScraper,     "welluswijs",        "/vacatures/"),
